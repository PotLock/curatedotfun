...
function Badge({ image, points, name, description }: BadgeProps) {
  return (
    <div className="rounded-md border py-2 px-3 bg-white border-neutral-100 flex items-center justify-between">
...
export function TopBadges() {
  return (
    <div className="border rounded-lg px-3 pb-3 border-neutral-300 gap-6 flex flex-col">
      <h3 className="text-neutral-500 font-sans text-5 font-bold py-[14] border-b border-dashed border-neutral-500">
        Top Badges
      </h3>
