...
export default function Leaderboard({
  ...
  return (
    <div className=" flex flex-col mx-auto ">
      ...
      <Container>
        <div className="flex flex-col md:flex-row  w-full md:w-full mx-auto justify-between items-center mb-6 gap-4 px-4 py-8">
        ...
        <div className="overflow-y-auto max-h-[500px] md:w-full mx-auto  scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
