...
export const LoginModal = ({ isOpen, onClose }: LoginModalProps) => {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await login('web3auth', { loginProvider: 'email_passwordless', login_hint: email });
      onClose();
    } catch (error) {
      ...
      <div className=" mx-auto">
        ...
        <div className="flex flex-col gap-4 py-4">
          <div className="space-y-4">
            <h6 className="text-sm font-medium">Social Login</h6>
            ...
            {/* Email Section */}
            <h6 className="text-sm font-medium">Email Login</h6>
            ...
            {/* Wallet Section */}
            <h6 className="text-sm font-medium">Wallet Login</h6>
            <Button
              variant="secondary"
              className="w-full flex items-center justify-center gap-2"
