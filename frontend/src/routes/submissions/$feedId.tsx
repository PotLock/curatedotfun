...
//       <div className="flex flex-col px-[70px] py-[30px] gap-[30px]">
//         <div className="flex flex-col gap-6 p-6 rounded-md border border-neutral-400 bg-white">
//           <div className="flex gap-[40px] items-start w-full border-b border-1 border-dashed border-black">
//             <img
...
//                 <h3 className="leading-10 text-2xl font-[900]">
//                   {feed?.name || `Feed: ${feedId}`}
//                 </h3>
//                 <Badge>#{feed?.id}</Badge>
//               </div>
//               <p className="text-base leading-[22px] text-neutral-800">
//                 {feed?.description ||
...
//           <div>
//             <h3 className="leading-10 text-2xl font-normal">Recent Content</h3>
//             <SubmissionList
//               items={items}
