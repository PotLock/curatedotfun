...
export class FeedService implements IBaseService {
  ...
  async getSubmissionsByFeed(feedId: string) {
    this.logger.info({ feedId }, "FeedService: getSubmissionsByFeed called");
    // Optional: Check if feed exists first, as in the route
