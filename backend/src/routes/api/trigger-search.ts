...
const triggerSearchRoutes = new Hono();

/**
 * Trigger processing of a specific rule
 * POST /api/trigger/search/:ruleId
 */
triggerSearchRoutes.post("/:ruleId", async (c) => {
 ...
 */
triggerSearchRoutes.post("/", async (c) => {
  const appContext = getAppContext(c);
  const ruleEngineService = appContext.ruleEngineService;
 ...
 * GET /api/trigger/search/state
 */
triggerSearchRoutes.get("/state", async (c) => {
  const appContext = getAppContext(c);
  const ruleEngineService = appContext.ruleEngineService;
 ...
 * DELETE /api/trigger/search/state
 */
triggerSearchRoutes.delete("/state", async (c) => {
  const appContext = getAppContext(c);
  const ruleEngineService = appContext.ruleEngineService;
 ...
 * PUT /api/trigger/search/state/:ruleId/:sourceId
 */
triggerSearchRoutes.put("/state/:ruleId/:sourceId", async (c) => {
...
export default triggerSearchRoutes;
