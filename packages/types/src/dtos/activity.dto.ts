...
export const activityTypeZodEnumSchema = z.enum(activityTypeValues); // for runtime validation and type inference
...
export const ActivityQueryOptionsSchema = z.object({
  ...
  type: activityTypeZodEnumSchema.optional(),
...
export const GetUserActivitiesInputSchema = z.object({
  ...
  options: ActivityQueryOptionsSchema.extend({
    types: z.array(activityTypeZodEnumSchema).optional(), // Hono route had comma-separated string
    from_date: z
      .string()
      .datetime({
...
export const GetMyActivitiesInputSchema = ActivityQueryOptionsSchema.extend({
  types: z.array(activityTypeZodEnumSchema).optional(),
  from_date: z
    .string()
    .datetime({
      message: "Invalid datetime string. Must be UTC and in ISO8601 format.",
