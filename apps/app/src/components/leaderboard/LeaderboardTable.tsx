...
export function LeaderboardTable({
  ...
  return (
    <div className="overflow-y-auto max-w-[calc(100vw-64px)] md:max-w-screen-xl md:w-full mx-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
